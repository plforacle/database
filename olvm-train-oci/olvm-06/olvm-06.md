...
Oracle Linux Virtualization Manager allows the import of existing OVA templates. Oracle provides pre-built OVA templates from the [Oracle Linux Cloud Images](https://yum.oracle.com/oracle-linux-templates.html) page.
...
1. Keep the default selections for the Data Center, Source, and Host drop-down lists.
...
1. For the File Path, enter `/tmp`.
   ...
   **Import process:**
   ...
   3. Disk image is uploaded to storage domain
   4. Template is created in OLVM database
   ...
   **Exam relevance (1Z0-1170):** Template import, management, and thin provisioning concepts are tested in "VM Lifecycle Management" and "Storage" domains. Therefore, you first need to ensure the template is in that location.
